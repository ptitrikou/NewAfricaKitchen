...
! function(t, e) {
    ...
    class hi extends B {
        ...
        _selectMenuItem({
            ...
            const i = V.find(".evs-dropdown-menu .evs-dropdown-item:not(.disabled):not(:disabled)", this._menu).filter(l);
    ...
    const _n = "scrollspy",
        ...
        yn = "active",
        wn = ".nav-link, .list-group-item, .evs-dropdown-item",
        En = "position";
    class An extends B {
        constructor(t, e) {
        ...
        _activate(t) {
            ...
            i.classList.add(yn), i.classList.contains("evs-dropdown-item") ? V.findOne(".dropdown-toggle", i.closest(".evs-dropdown")).classList.add(yn) : V.parents(i, ".nav, .list-group").forEach((t => {
    ...
    class xn extends B {
        ...
        _transitionComplete(t, e, i) {
            if (e) {
                ...
                const t = V.findOne(":scope > .evs-dropdown-menu .active", e.parentNode);
                t && t.classList.remove(Tn), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !1)
            }
            t.classList.add(Tn), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), u(t), t.classList.contains(On) && t.classList.add(Cn);
            let n = t.parentNode;
            if (n && "LI" === n.nodeName && (n = n.parentNode), n && n.classList.contains("evs-dropdown-menu")) {
                const e = t.closest(".evs-dropdown");
